    ...
    return(
        <form className={styleContactezNous.formulaire} onSubmit={handleSubmit}>
            ...
            <div className={styleContactezNous.champ}>
                    ...
                    <input type="email" name="email" className={styleContactezNous.email}  onChange={(e) => setEmail(e.target.value)} placeholder='Email' ></input>

                    <input type="text" name="telephone" className={styleContactezNous.full_name}  onChange={(e) => setTelephone(e.target.value)} placeholder='Téléphone' required></input>
          
                    <input type="text" name="secteur_activité" className={styleContactezNous.full_name}  onChange={(e) => setSecteur(e.target.value)} placeholder="Secteur d'activité" required></input>
     
                    <input className={styleContactezNous.message} type="text" name="message" placeholder='Message'  onChange={(e) => setMessage(e.target.value)} required />

                <motion.button type="submit" whileHover={{ boxShadow: '0px 0px 30px rgba(0,0,0,0.6)', scale: 1.1, cursor: 'pointer'}} className={styleContactezNous.div_submit}>Envoyer</motion.button>
            </div>

...
function Banner() {
    return <div className={styleStudio.Banner}> <span>Anniversaire</span></div>
}
...
function Projet({image,titre}) {
    return (
        <div className={styleStudio.layoutProjet}>
            ...
            <h1 className={styleStudio.titre_projet}>photo anniversaire</h1>
        </div>
    )
}
...
function SectionProjet() {
    const projets = [
        {
            key: 0,
            img: "url('/assets/IMG-20230813-WA0064.jpg')",
     
        },
        {
            key: 1,
            img: "url('/assets/IMG-20230813-WA0062.jpg')",
        
        },
        {
            key: 2,
            img: "url('/assets/IMG-20230813-WA0058.jpg')",
   
        },
        {
            key: 3,
            img: "url('/assets/IMG-20230813-WA0049.jpg')",

        },
        {
            key: 4,
            img: "url('/assets/IMG-20230813-WA0048.jpg')",

        },
        {
            key: 5,
            img: "url('/assets/IMG-20230813-WA0056.jpg')",

        },
        {
            key: 6,
            img: "url('/assets/IMG-20230813-WA0053.jpg')",

        },
        {
            key: 7,
            img: "url('/assets/IMG-20230813-WA0054.jpg')",

        },
        {
            key: 8,
            img: "url('/assets/IMG-20230813-WA0055.jpg')",

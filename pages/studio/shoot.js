...
function Banner() {
    return <div className={styleStudio.Banner}> <span>Shoot</span></div>
}
...
function Projet({image,titre}) {
    return (
        <div className={styleStudio.layoutProjet}>
            ...
            <h1 className={styleStudio.titre_projet}>SHOOT</h1>
        </div>
    )
}
...
function SectionProjet() {
    const projets = [
        ...
        {
            key: 2,
            img: "url('/assets/IMG-20230813-WA0109.jpg')",
            
        },
        {
            key: 3,
            img: "url('/assets/IMG-20230813-WA0106.jpg')",
          
        },
        {
            key: 4,
            img: "url('/assets/IMG-20230813-WA0107.jpg')",
            
        },
        {
            key: 5,
            img: "url('/assets/IMG-20230813-WA0108.jpg')",

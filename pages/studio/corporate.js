...
function Banner() {
    return <div className={styleStudio.Banner}> <span>Corporate</span></div>
}
...
function Projet({image,titre}) {
    return (
        <div className={styleStudio.layoutProjet}>
            ...
            <h1 className={styleStudio.titre_projet}>Corporate</h1>
        </div>
    )
}
...
function SectionProjet() {
    const projets = [
        {
            key: 1,
            img: "url('/assets/IMG-20230813-WA0099.jpg')",
        ...
        {
            key: 2,
            img: "url('/assets/IMG-20230813-WA0100.jpg')",
            
        },
        {
            key: 3,
            img: "url('/assets/IMG-20230813-WA0092.jpg')",
          
        },
        {
            key: 4,
            img: "url('/assets/IMG-20230813-WA0093.jpg')",
        ...
        {
            key: 7,
            img: "url('/assets/IMG-20230813-WA0097.jpg')",
      
        },
        {
            key: 8,
            img: "url('/assets/IMG-20230813-WA0091.jpg')",
        }
    ]
